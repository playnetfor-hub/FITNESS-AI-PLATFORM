...
const exampleQueriesAr = [
    ...
    "هل الكينوا بروتين كامل؟",
    "مصادر صحية لأحماض أوميغا 3 الدهنية",
...
const NutritionSearch: React.FC = () => {
  ...
  return (
    <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
      <h3 className="text-xl font-bold text-gray-900 dark:text-white">{t.nutritionSearchTitle}</h3>
      <p className="text-gray-500 dark:text-gray-400 mb-4">
        {t.nutritionSearchSubtitle}
      </p>
      <form onSubmit={handleSearch} className="flex gap-2 mb-6">
        <input
          ...
          placeholder={t.nutritionSearchPlaceholder}
